    ...
    if(x1 >= 0 && x1 < 8 && y1 >= 0 && y1 < 8 && !paused) {
        ...
        if(x == -1 || y == -1) {
            ...
            if(possible[x1][y1]) {
                ...
                update_castle(x1, y1);
                if(sound) board.play_sound(position[x1][y1] != ' ');
